...
class Formulario extends Component
{
    ...
    public $documento_id,$user,$file,$fecha_nacimiento,$name,$lastname,$geners,$direccion,$gener_id,$paises,$pais_id,$zip_code,$instagram,$facebook,$doc_frente,$doc_reverso,$selfie,$video,$caduca,$fecha_caducidad,$terminos;
    ...
    public function procesar(){
        ...
        if($this->terminos){
           ...
           // Toaster::success('Su solicitud ha sido procesada, espere la respuesta ');
            ...
            Toaster::error('Debe aceptar terminos y condiciones para procesar la solicitud');
        }
