...
input[type="file"] {
    ...
    cursor: pointer;
            ...
            <div  class="font-general form bg-white p-6 my-10 relative container">
                ...
                <div class="icon bg-blue-600 text-white w-6 h-6 absolute flex items-center justify-center p-3 " ></div>
                <h3 class="text-2xl ml-12   text-gray-900 font-semibold" >Documentos</h3>
                ...
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="relative">
                            <label class="custom-file-upload flex  w-full font-semibold bg-white rounded-md ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="relative">
                            <label class="custom-file-upload flex  w-full font-semibold bg-white rounded-md ">
                                ...
                                Seleccionar foto sosteniendo documento de identificación
                            </label>
                        </div>
